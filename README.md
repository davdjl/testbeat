...
`${GOPATH}/src/github.com/jackcloudman/testbeat`
...
```
git remote set-url origin https://github.com/jackcloudman/testbeat
...
```
mkdir -p ${GOPATH}/src/github.com/jackcloudman/testbeat
git clone https://github.com/jackcloudman/testbeat ${GOPATH}/src/github.com/jackcloudman/testbeat
```
